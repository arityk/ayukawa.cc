...
<head profile="http://purl.org/net/ns/metaprof">
	...
	<?php else: ?>
		<link type="text/css" rel="stylesheet" href="style.css?190524" />
		<script type="text/javascript" src="default.js?190522"></script>
	<?php endif; ?>
...
<div id="container" class="clearfix">
	...
	<div id="goaisatsu">
		...
		<div class="left-box">
			...
			<p>当店の鮎はとても好評を頂いております。この鮎は鮎釣りが大好きな店主が自ら釣り上げたものです。鮎釣りが解禁となる毎年6月下旬から9月半ばまで毎日釣りに行っています。</p>
			
			<div class="center">
				<img class="mobile" src="images/goaisatsu-photo1.jpg" alt="釣った鮎" />
			</div>
			
			<p>自ら釣り上げた鮎をお客様にお出しするのはこのあたりではとても珍しく、新鮮な鮎はひと味もふた味も違います。味の違いを是非堪能してください。</p>
			<p>鮎は「香魚」とも呼ばれ、新鮮な鮎だとスイカのような、キュウリのような良い香りがします。身がしっとりして柔らかでとても美味しく、内臓のほろ苦さはお酒にとても良く合います。</p>
			
			<p>その香り高く新鮮な鮎を、店主のこだわりの焼き方で焼く「塩焼き」「一夜干し」などをお楽しみ下さい。</p>
		...
		<div class="left-box">
			...
			<p>伊那谷の方たちも馬刺しが大好きです。当店の馬刺しは本場熊本から取り寄せています。赤身をはじめ、ふたえご、たてがみ、ハラミもご用意しています。このほか、ハツ、タンなどの超希少部位も不定期ですが入荷いたします。</p>
			<p>本場の馬刺しはとても好評で、噛むほどに甘みを感じます。是非一度お試し下さい。</p>
			...
			<p>沢山のお客様に味わって頂きたいので、お料理はお安く提供しています。どうぞお気軽に足をお運び下さい。</p>
			<p>心よりお待ちしております。</p>
		</div>
	...
	<div id="oshinagaki">
		...
		<div class="bg">
			<div class="list">
				<img src="images/oshinagaki.png?190523" title="お品書き" />
			</div>
		</div>
	</div>
	...
	<div id="location">
		...
		<div class="info">
			...
			<ul>
				<li>営業時間: 17:00 ～ 23:00 / 定休日: 日曜日 と 第一月曜日</li>
